		...
		<div className={className}>
			...
			<div className='mt-5 border-y border-y-neutral-100 py-6 pb-7'>
				...
				<div className='flex gap-3 mb-5'>
					<Input type='number' placeholder='от 299' min={299} max={1999}/>
					<Input type='number' placeholder='до 1999' min={399} max={1999}/>
				</div>
				<RangeSlider min={299} max={1999} step={10} value={[299, 1999]}/>
			</div>
